package com.example.chargingPileSystem.wechatPay.nativepay;
...
public class NativePayServiceExample {
  ...
  /** 商户API私钥路径 */
  public static String privateKeyPath = "src/main/resources/certificate/wechat_pay_certificate.pem";
  /** 商户证书序列号 */
